...
INSERT INTO applications (name, company, industry, description) VALUES
('Software Intern 1', 'Google', 'Tech', 'This be a cool job'),
('Software Intern 2', 'Meta', 'Tech', 'This be a cool job'),
('Software Intern 3', 'Apple', 'Tech', 'This be a cool job'),
('Software Intern 4', 'Amazon', 'Tech', 'This be a cool job'),
('Software Intern 5', 'Netflix', 'Tech', 'This be a cool job');
